...
def longest_bridge_strength(port, components):
    ...
    for component in all_having_port:
        ...
        length, strength = longest_bridge_strength(other_port, without_current)
        results.append((length + 1, strength + port + other_port))
...
def solve(components):
    ...
    _, streangth = longest_bridge_strength(start_port, components)
